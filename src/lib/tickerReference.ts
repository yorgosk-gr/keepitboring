...
export const KNOWN_ETFS: Record<string, ETFInfo> = {
  ...
  NDIA: { ticker: "NDIA", name: "iShares MSCI India UCITS ETF", category: "equity", geography: "india", is_broad_market: false, exchange: "LSE", currency: "USD" },
  ...
  IGLN: { ticker: "IGLN", name: "iShares Physical Gold ETC", category: "commodity", geography: "global", is_broad_market: false, exchange: "LSE", currency: "USD" },
  ...
  IJPA: { ticker: "IJPA", name: "iShares MSCI Japan UCITS ETF (USD Acc)", category: "equity", geography: "japan", is_broad_market: false, exchange: "LSE", currency: "USD" },
  ...
  CBUX: { ticker: "CBUX", name: "iShares Global Infrastructure UCITS ETF (USD Acc)", category: "equity", geography: "global", is_broad_market: false, exchange: "XETRA", currency: "USD" },
  XDWH: { ticker: "XDWH", name: "Xtrackers MSCI World Health Care UCITS ETF", category: "equity", geography: "global", is_broad_market: false, exchange: "XETRA", currency: "EUR" },
  IBZL: { ticker: "IBZL", name: "iShares MSCI Brazil UCITS ETF USD (Dist)", category: "equity", geography: "brazil", is_broad_market: false, exchange: "LSE", currency: "USD" },
  GRE1: { ticker: "GRE1", name: "Amundi MSCI Greece UCITS ETF Dist", category: "equity", geography: "greece", is_broad_market: false, exchange: "EURONEXT", currency: "EUR" },
  GRE: { ticker: "GRE", name: "Amundi MSCI Greece UCITS ETF Dist", category: "equity", geography: "greece", is_broad_market: false, exchange: "EURONEXT", currency: "EUR" },
  IUQA: { ticker: "IUQA", name: "iShares Edge MSCI USA Quality Factor UCITS ETF (USD Acc)", category: "equity", geography: "us", is_broad_market: true, exchange: "LSE", currency: "USD" },
  ...
  INFR: { ticker: "INFR", name: "iShares Global Infrastructure UCITS ETF (USD Dist)", category: "equity", geography: "global", is_broad_market: false, exchange: "LSE", currency: "USD" },
  IQQI: { ticker: "IQQI", name: "iShares Global Infrastructure UCITS ETF (USD Dist)", category: "equity", geography: "global", is_broad_market: false, exchange: "XETRA", currency: "EUR" },
  IUIT: { ticker: "IUIT", name: "iShares S&P 500 IT Sector UCITS ETF", category: "equity", geography: "us", is_broad_market: false, exchange: "LSE", currency: "USD" },
  INRG: { ticker: "INRG", name: "iShares Global Clean Energy UCITS ETF", category: "equity", geography: "global", is_broad_market: false, exchange: "LSE", currency: "USD" },
  SGLN: { ticker: "SGLN", name: "iShares Physical Gold ETC", category: "commodity", geography: "global", is_broad_market: false, exchange: "LSE", currency: "GBP" },
  PHAU: { ticker: "PHAU", name: "WisdomTree Physical Gold", category: "commodity", geography: "global", is_broad_market: false, exchange: "LSE", currency: "USD" },
  ...
  GLD: { ticker: "GLD", name: "SPDR Gold Trust", category: "commodity", geography: "global", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  ...
  ARKK: { ticker: "ARKK", name: "ARK Innovation ETF", category: "equity", geography: "us", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  ...
  EWJ: { ticker: "EWJ", name: "iShares MSCI Japan ETF", category: "equity", geography: "japan", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  INDA: { ticker: "INDA", name: "iShares MSCI India ETF", category: "equity", geography: "india", is_broad_market: false, exchange: "NASDAQ", currency: "USD" },
  EWZ: { ticker: "EWZ", name: "iShares MSCI Brazil ETF", category: "equity", geography: "brazil", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  FXI: { ticker: "FXI", name: "iShares China Large-Cap ETF", category: "equity", geography: "china", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  ...
  XLE: { ticker: "XLE", name: "Energy Select Sector SPDR Fund", category: "equity", geography: "us", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  XLK: { ticker: "XLK", name: "Technology Select Sector SPDR Fund", category: "equity", geography: "us", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  XLF: { ticker: "XLF", name: "Financial Select Sector SPDR Fund", category: "equity", geography: "us", is_broad_market: false, exchange: "NYSE", currency: "USD" },
  XLV: { ticker: "XLV", name: "Health Care Select Sector SPDR Fund", category: "equity", geography: "us", is_broad_market: false, exchange: "NYSE", currency: "USD" },
};
